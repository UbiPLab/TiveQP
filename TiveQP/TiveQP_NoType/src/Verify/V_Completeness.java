...
import static Query.Query.toByteArray;
import static Verify.V_Correctness.addBytes;

public class V_Completeness {
    public static boolean verify_Completeness(List<Query.Proof_Tree> p_tree, List<Query.Proof_SubTree> p_subtree, String[][] T2, String[][] T3, int ibf_length, int rb, String[] Keylist){
        boolean flag = true;
        ...
        if (flag == true){
            for (Query.Proof_SubTree proof_tree :p_subtree) {
