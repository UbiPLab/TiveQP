...
import BulidTree.Reload;
import BulidTree.TreeCon;
import BulidTree.TreeCon;
import Parameter.TiveQP_NoType_parameters;
import Query.Query;
import Trapdoor.Trap;
import Verify.V_Completeness;
import Verify.V_Correctness;
import Trapdoor.Trap;
import Verify.V_Completeness;
import Verify.V_Correctness;
...
public class AdvanceSupplement {
    public static void main(String[] args) throws Exception {
        String fileName = TiveQP_NoType_parameters.fileName;
...
//
        ...
        String[] op_10 = {
                ...
                "Home Services**COLUMBUS**39.954702**-83.0821473**6**30**15**0",
                "Active Life**VANCOUVER**49.2815215011**-123.0362366906**11**0**17**0",
                "American (Traditional)**ORLANDO**28.3933375838**-81.4653114974**11**0**22**0",
        ...
        String[] user_input = {//  2w
                ...
                "Home Services**COLUMBUS**39.954702**-83.0821473**12**12",
                "Active Life**VANCOUVER**49.2815215011**-123.0362366906**12**12",
                // 4w
                "American (Traditional)**ORLANDO**28.3933375838**-81.4653114974**12**12",
                // 6w
...
//        for (int i = 0; i < num_k.length; i++) {
        for (int i = 0; i < 1; i++) {
            ...
            System.out.println("eve = "+op_10[choose]);
            long row_query = 0;
            long row_proof = 0;
            long row_vrifiy = 0;
