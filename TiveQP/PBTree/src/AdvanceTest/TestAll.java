...
public class TestAll {
    public static void main(String[] args) throws Exception {
        String fileName = PBTree_paremeters.fileName;
...
////        MyUtil.Show.ShowMatrix(T3);
        ...
        for (int i = 0; i < num_k.length; i++) {
            ...
            for (int j = 0; j < 11; j++) {
                ...
                String[][] T1 = new TrapdoorCompute().T1(eve[9][0], Keylist);
//        System.out.println("T1 :");
//        MyUtil.Show.ShowMatrix(T1);

                String[][] T2 = new TrapdoorCompute().T2(eve[9][1], Double.parseDouble(eve[9][2]), Double.parseDouble(eve[9][3]), Keylist);
//        System.out.println("T2 :");
//        MyUtil.Show.ShowMatrix(T2);
...
//        MyUtil.Show.ShowMatrix(T3);
                ...
                new Cloud_Query().Query_Tree(root, T1, T2, T3, ibf_length, time_query, result, num_k[i]);
