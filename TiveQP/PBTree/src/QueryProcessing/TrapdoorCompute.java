...
public class TrapdoorCompute {
    ...
    public static String[][] T1(String type ,String[] Keylist ) throws Exception {
        ...
        for (int w=0;w<type_Prefix.length;w++) {                     // twice hash
            for (int i = 0; i < Keylist.length - 1; i++) {
                ...
                result[w][i]= toHexString(outbytes);    //trapdoor M element
            }
        }
        return result;                     // return trapdoor
    }

    public static String[][] T2(String city, double lat, double lng ,String[] Keylist ) throws Exception {
    ...
    public static String[][] T3(int hour_open,int min_open ,String[] Keylist ) throws Exception {
