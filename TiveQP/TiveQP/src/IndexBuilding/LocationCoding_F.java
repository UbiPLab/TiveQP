...
public class LocationCoding_F {
    ...
    public String[] City_Encoding(String city_name, double lat, double lng){
        ...
        int encode = (int) (num_lng * 10 + num_lat);

        if (num_lat == 0){
            if (num_lng == 0){
                //  左下角
                String[] n1 = IndexElementEncoding.range(bitsize,encode,encode+1);
                String[] n2 = IndexElementEncoding.range(bitsize,encode+10,encode+11);
                ...
                //  左上角
                String[] n1 = IndexElementEncoding.range(bitsize,encode,encode+1);
                String[] n2 = IndexElementEncoding.range(bitsize,encode-10,encode-9);
                String[] result = new String[n1.length+n2.length];
                for (int i = 0; i < n2.length; i++) {
                    result[i] = n2[i];
                }
                ...
                //  左边
                String[] n1 = IndexElementEncoding.range(bitsize,encode-10,encode-9);
                String[] n2 = IndexElementEncoding.range(bitsize,encode,encode+1);
                String[] n3 = IndexElementEncoding.range(bitsize,encode+10,encode+11);
            ...
            if (num_lng == 0){
                ...
                String[] n2 = IndexElementEncoding.range(bitsize,encode+9,encode);
                ...
                //  右上角
                String[] n1 = IndexElementEncoding.range(bitsize,encode-11,encode-10);
                ...
                String[] n1 = IndexElementEncoding.range(bitsize,encode-11,encode-10);
                String[] n2 = IndexElementEncoding.range(bitsize,encode-1,encode);
                String[] n3 = IndexElementEncoding.range(bitsize,encode+9,encode+10);
                String[] result = new String[n1.length+n2.length+n3.length];
                for (int i = 0; i < n1.length; i++) {
                    result[i] = n1[i];
                }
            ...
            if (num_lng == 0){
                ...
                String[] n2 = IndexElementEncoding.range(bitsize,encode+9,encode+11);
                ...
                //  上边
                String[] n1 = IndexElementEncoding.range(bitsize,encode-11,encode-9);
                ...
                String[] n1 = IndexElementEncoding.range(bitsize,encode-11,encode-9);
                String[] n2 = IndexElementEncoding.range(bitsize,encode-1,encode+1);
                String[] n3 = IndexElementEncoding.range(bitsize,encode+9,encode+11);
                String[] result = new String[n1.length+n2.length+n3.length];
                for (int i = 0; i < n1.length; i++) {
                    result[i] = n1[i];
                }
    ...
    public String[] City_Encoding_Complement(String city_name, double lat, double lng){
        ...
        if (num_lat == 0){
            if (num_lng == 0){
                //  左下角
                String[] n1 = IndexElementEncoding.range(bitsize,encode+2,encode+9);
                String[] n2 = IndexElementEncoding.range(bitsize,encode+12,time*time);
                String[] result = new String[n1.length+n2.length];
                for (int i = 0; i < n1.length; i++) {
                    result[i] = n1[i];
                }
                ...
                //  左上角
                String[] n1 = IndexElementEncoding.range(bitsize,0,encode-11);
                String[] n2 = IndexElementEncoding.range(bitsize,encode-8,encode-1);
                ...
                String[] n2 = IndexElementEncoding.range(bitsize,encode+2,encode+9);
                String[] n3 = IndexElementEncoding.range(bitsize,encode+12,time*time);
                String[] result = new String[n1.length+n2.length+n3.length];
                for (int i = 0; i < n1.length; i++) {
                    result[i] = n1[i];
                }
            ...
            if (num_lng == 0){
                ...
                String[] n2 = IndexElementEncoding.range(bitsize,encode+1,encode+8);
                String[] n3 = IndexElementEncoding.range(bitsize,encode+11,time*time);
                ...
                //  右上角
                String[] n1 = IndexElementEncoding.range(bitsize,0,encode-12);
                String[] n2 = IndexElementEncoding.range(bitsize,encode-9,encode-2);
                ...
                String[] n1 = IndexElementEncoding.range(bitsize,0,encode-12);
                String[] n2 = IndexElementEncoding.range(bitsize,encode-9,encode-2);
                String[] n3 = IndexElementEncoding.range(bitsize,encode+1,encode+8);
                String[] n4 = IndexElementEncoding.range(bitsize,encode+11,time*time);
            ...
            if (num_lng == 0){
                ...
                //  正常
                String[] n1 = IndexElementEncoding.range(bitsize,0,encode-2);
                String[] n2 = IndexElementEncoding.range(bitsize,encode+2,encode+8);
                String[] n3 = IndexElementEncoding.range(bitsize,encode+12,time*time);
                String[] result = new String[n1.length+n2.length+n3.length];
                for (int i = 0; i < n1.length; i++) {
                    result[i] = n1[i];
