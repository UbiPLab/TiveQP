...
//        public int[] index;
    ...
    public void Query_Tree(Construction.TiveTreeNode root , String[][] T1, String[][] T2, String[][] T3, int ibf_length ,
                           int rb, List<Cloud_Query.Proof_Tree> p_tree, List<Cloud_Query.Proof_SubTree> p_subtree, List<Cloud_Query.Proof_Result> result, List<Cloud_Query.Proof_UNN> Proof_UNN,
...
//        long time = 0;
        if (check_time >= num_k){
            ...
            Cloud_Query.Proof_UNN proof_unn = new Cloud_Query.Proof_UNN();
...
//                    time_proof.add(e_proof-s_proof);
    ...
    public static boolean Query_T1(String[][] Trapdoor, Construction.TiveTreeNode root, int ibf_length , int rb, List<Cloud_Query.Proof_Tree> p_tree, List<Cloud_Query.Proof_SubTree> p_subtree, List<byte[]> HV_list,
...
//            GenerateProof_T1()
            ...
            Cloud_Query.Proof_Tree proof = new Cloud_Query.Proof_Tree();
            proof.address = root.address;
//            proof.line = 0;
            // return bits and Hv
    ...
    public static boolean Query_T2_T3(String[][] T2, String[][] T3, Construction.TiveTreeNode root, int ibf_length , int rb, List<Cloud_Query.Proof_Tree> p_tree, List<Cloud_Query.Proof_SubTree> p_subtree, List<Cloud_Query.Proof_Result> result, List<byte[]> HV_list,
                                      List<Long> time_query, List<Long> time_proof) throws NoSuchAlgorithmException {
        long start = System.currentTimeMillis();
        boolean flag = false;
...
//                    break;
            ...
            if (time == 0){
                flag = false;
                long s_proof = System.currentTimeMillis();
                Cloud_Query.Proof_SubTree proof = new Cloud_Query.Proof_SubTree();
...
//                    proof.line_tcs = i;
                ...
                if (root.height == 1) {
                    ...
                    long s_proof = System.currentTimeMillis();
                    Cloud_Query.Proof_Result result_proof = new Cloud_Query.Proof_Result();
...
//            proof.HV_TCS = root.HV_TCS;
    ...
    public static void GenerateProof_T1(String[][] Trapdoor, Construction.TiveTreeNode root, int ibf_length , int rb, List<Cloud_Query.Proof_Tree> p_tree, List<Cloud_Query.Proof_SubTree> p_subtree, List<byte[]> HV_list,
