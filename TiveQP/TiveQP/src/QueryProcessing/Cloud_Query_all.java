...
//            proof.line = 0;
            // return bits and Hv
            proof.bits_YCS = CopyMatrix(root.bits_YCS);
            proof.HV_YCS = CopyMatrix(root.HV_YCS);
...
////                proof.address = root.address;
//                proof.line_lcs = i;
//                proof.bits_LCS = root.bits_LCS[i];
//                proof.HV_LCS = root.HV_LCS[i];
//
////                proof.HV = root.HV;
//                long e_proof = System.currentTimeMillis();
//                time_proof.add(e_proof-s_proof);
...
//                    proof.line_tcs = i;
                proof.bits_TCS = CopyMatrix(root.bits_TCS);
                proof.HV_TCS = CopyMatrix(root.HV_TCS);
                HV_list.add(root.HV);
                p_subtree.add(proof);
                long e_proof = System.currentTimeMillis();
                time_proof.add(e_proof-s_proof);
...
//                    result.add(plaintext);
            ...
            proof.HV = CopyHL(root.HV);
//                    proof.line_lcs = i;
            proof.bits_LCS = CopyMatrix(root.bits_LCS);
            proof.HV_LCS = CopyMatrix(root.HV_LCS);
