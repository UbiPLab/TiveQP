...
//        public byte[][] HV_YCS;
    ...
    public void Query_Tree(TreeCon.TiveTreeNode root , String[][] T2, String[][] T3, int ibf_length ,
...
//                        list_height.add(root.height);
                        Query_Tree(root.left,T2,T3,ibf_length,rb,p_tree,p_subtree,result,Proof_UNN, HV_list,list_height,time_query,time_proof,num_k);
                        Query_Tree(root.right,T2,T3,ibf_length,rb,p_tree,p_subtree,result,Proof_UNN, HV_list,list_height,time_query,time_proof,num_k);
                    }
...
//                    time_proof.add(e_proof-s_proof);
    ...
    public static boolean Query_T2_T3(String[][] T2, String[][] T3,TreeCon.TiveTreeNode root, int ibf_length , int rb, List<Proof_Tree> p_tree,List<Proof_SubTree> p_subtree, List<Proof_Result> result,List<byte[]> HV_list,
...
//            proof.line = 0;
    ...
    public static int bit_num (List<Proof_SubTree> proof_subTree_list, List<Proof_Tree> proof_tree_list){
        int num = 0;
        for (Proof_SubTree sub:proof_subTree_list) {
