...
public class V_Correctness {
    public static boolean verify_Correctness_Decrypt(List<Query.Proof_Result> C , String user_input){
        boolean flag = false;
        int right_count = 0;
        String[] strs_user = user_input.split("\\*\\*");
        //  "Restaurants**ATLANTA**33.78860826**-84.3690906**12**11"

        for (Query.Proof_Result s:C) {
            ...
            //  判断
            if (strs_user[1].equals(result[1]) &&
