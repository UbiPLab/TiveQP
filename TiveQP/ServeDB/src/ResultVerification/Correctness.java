...
public class Correctness {
    public static boolean verify_Correctness_Decrypt(List<Cloud_Query.Proof_MT> C , String user_input){
        boolean flag = false;
        int right_count = 0;
        String[] strs_user = user_input.split("\\*\\*");
        //  "Restaurants**ATLANTA**33.78860826**-84.3690906**12**11"

        for (Cloud_Query.Proof_MT s:C) {
...
//            System.out.println();
            ...
            for (int i = 0; i < HV_list.size() -1; i++) {
