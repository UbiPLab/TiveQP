...
public class IndexElementEncoding {
     ...
     * @return  字符数组
     */
    public static String[] range(int bitsize, int down, int up) throws Exception {// range[down,up] of bitsize bit       S[0,8] = { 0***,1000 }

        if (down == up){
            String[] result = new String[1];
            result[0] = IndexElementEncoding.prefix(bitsize,down)[0];
            return result;
        }else {
