...
public class TimeEncoding {
     ...
     */
    public String[] TimeEncoding_owner(int hour_open,int min_open,int hour_close,int min_close) throws Exception {
    ...
    public String[] TimeEncoding_owner_Complement(int hour_open,int min_open,int hour_close,int min_close) throws Exception {
        int time_open = hour_open*2;
        if (min_open>=30){
            time_open++;
        }
...
//    }
    ...
    public String[] TimeTimeRange(int down,int up) throws Exception {
