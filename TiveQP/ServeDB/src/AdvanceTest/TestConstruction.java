...
import PBTree.PBTreeConstruction_IF;
...
//        System.out.println(randNumber);
        ...
        PBTreeConstruction.PBNode root = new PBTreeConstruction_IF().BuildPBTree(dataSet);
...
//        System.out.println(RamUsageEstimator.sizeOf(root));
        ...
        long time = new PBTreeConstruction_IF().initNode(root,ibf_length,Keylist);
