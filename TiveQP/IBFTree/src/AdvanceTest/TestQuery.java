...
//        int[] num_k ={1,5,10,15,20};
        ...
        for (int i = 0; i < num_k.length; i++) {
            ...
            for (int j = 0; j < 10; j++) {
                ...
                String[][] T1 = new TrapdoorCompute().T1(eve[6][0], Keylist,randNumber);
//        System.out.println("T1 :");
//        MyUtil.Show.ShowMatrix(T1);

                String[][] T2 = new TrapdoorCompute().T2(eve[6][1], Double.parseDouble(eve[6][2]), Double.parseDouble(eve[6][3]), Keylist,randNumber);
//        System.out.println("T2 :");
//        MyUtil.Show.ShowMatrix(T2);
...
//                }
        ...
        System.out.println("time_query_ave = " + (ttt));
    }
}
