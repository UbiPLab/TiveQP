...
public class IndexElementEncoding {
    ...
    public static String[] typeUnit(String[] n1,String[] n2){
        int a = Integer.parseInt(n1[0]);
        int b = Integer.parseInt(n2[0]);
        if (a<b){
            return IndexElementEncoding.range(11,a,b);
        }else {
            return IndexElementEncoding.range(11,b,a);
        }
    }
