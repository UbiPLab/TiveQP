...
//            System.out.println(result.size());
                ...
                System.out.println( RamUsageEstimator.sizeOf(proof_subTree_list)+RamUsageEstimator.sizeOf(proof_tree_list)+RamUsageEstimator.sizeOf(proof_unns)+RamUsageEstimator.sizeOf(result));
            }
        }
